...
\tadAxiomas[\paratodo{Juego}{g}, \paratodo{Pokemon}{p}, \paratodo{Jugador}{j, j'}, \paratodo{conj(Jugador)}{js}, \paratodo{Coordenada}{c}]
	...
	\tadAxioma{ultimos10Movimientos(moverJugador(g, j, c))}{if $long(ultimos10Movimientos(g)) < 10$) then ultimos10Movimientos $\argumento$ <j, c> else fin(ultimos10Movimientos(g)) $\argumento$ <j, c> fi}
	\tadAxioma{ultimos10Movimientos(conectar(g, j, c))}{if $long(ultimos10Movimientos(g)) < 10$) then ultimos10Movimientos $\argumento$ <j, c> else fin(ultimos10Movimientos(g)) $\argumento$ <j, c> fi}
