...
\tadIgualdadObservacional{g_1}{g_2}{juego}{$jugadores(g_1) \igobs jugadores(g_2) \wedge jugadoresBanneados(g_1) \igobs jugadoresBanneados(g_2) \wedge pokemonesLibres(g_1) \igobs pokemonesLibres(g_2) \wedge mapa(g_1) \igobs mapa(g_2) \wedge ultimos10Movimientos(g_1) \igobs ultimos10Movimientos(g_2) \wedge (\forall j:jugador)(j \in jugadores(g_1)) \impluego posActualJugador(g_1, j) \igobs posActualJugador(g_2, j) \wedge conectado?(g_1, j) \igobs conectado?(g_2, j) \wedge pokemonesCapturados(g_1, j) \igobs pokemonesCapturados(g_2, j) \wedge sanciones(g_1, j) \igobs sanciones(g_2, j)$}
